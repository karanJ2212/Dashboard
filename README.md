...
# 📖 Reslink Dashboard<a name="about-project"></a>

Introducing the ResLink Responsive Dashboard: A sleek, user-friendly interface brought to life with ReactJS and Material UI. This dashboard, created based on the provided Figma design, demonstrates proficiency in frontend development, particularly in state management techniques. Enjoy a responsive experience across devices and screens, making data interaction a breeze.
...
-[Live Demo Link](https://reslink-dashboard.netlify.app/)
